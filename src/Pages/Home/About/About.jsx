        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                <div className='lg:w-1/2 relative'>
                    ...
                    <img src={parts} className="absolute right-20 -bottom-10  w-1/2 rounded-lg shadow-2xl border-8 border-white" />
                </div>
                <div className='lg:w-1/2'>
                    <h2 className='text-[20px] text-[#FF3811] font-bold '>About Us</h2>
